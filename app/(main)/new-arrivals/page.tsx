      ...
      <section className="h-[70vh] min-h-[500px] w-full flex flex-col items-center justify-center text-center px-6 bg-zinc-50 border-b border-zinc-100 relative overflow-hidden">
         ...
         >
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <span className="text-[12px] uppercase tracking-[0.6em] font-black text-accent">Season 2026 Collection</span>
            </div>
            ...
            <p className="text-zinc-500 text-xs md:text-sm font-medium max-w-xl mx-auto uppercase tracking-[0.4em] leading-[2]">
               Explore our latest artisanal creations, where master craftsmanship meets innovative design. Every piece is a testament to the ElvaEdit pursuit of eternal elegance.
            </p>
         </motion.div>
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 py-16">
        ...
        <div className="hidden md:flex items-center justify-between mb-16 pb-8 border-b border-zinc-50">
           <p className="text-[11px] uppercase tracking-[0.3em] text-zinc-400">
             Currently Displaying <span className="text-zinc-900 font-bold">{filteredProducts.length}</span> Handcrafted Pieces
           </p>
           <button 
        ...
        <div className="flex flex-col md:flex-row gap-20 relative">
          ...
          {/* 3. Universal Filter Drawer (Mobile) & Sidebar (Desktop) */}
          <AnimatePresence>
            {isMobileFilterOpen && (
              <>
                <motion.div 
          ...
          <div className="flex-grow">
            ...
            {filteredProducts.length === 0 && (
              <div className="flex flex-col items-center justify-center py-48 text-center bg-zinc-50 rounded-[48px] border border-dashed border-zinc-200">
                ...
                <h3 className="text-2xl font-light uppercase tracking-[0.5em] mb-6">No Masterpieces Found</h3>
                <p className="text-zinc-400 text-[11px] uppercase tracking-[0.3em] max-w-sm mx-auto leading-loose">The current refinement has left our gallery empty. Please adjust your discovery filters.</p>
                <button 
                  onClick={() => {
...
function FilterContent({ 
  ...
  return (
    <div className="space-y-16">
      ...
      {/* Arrangement Suite */}
      <div>
        <h3 className="text-[11px] font-black uppercase tracking-[0.4em] text-zinc-900 mb-10">Sequencing</h3>
        <div className="flex flex-col gap-6">
            <button 
      ...
      >
        Clear Refinement <X className="w-4 h-4" />
      </button>
    </div>
  );
}
...
export default function NewArrivalsPage() {
  return (
    <Suspense fallback={<div className="container mx-auto px-4 py-32 text-center text-[10px] font-black uppercase tracking-[0.5em] animate-pulse">Syncing New Arrival Hub...</div>}>
      <NewArrivalsContent />
    </Suspense>
  );
}
