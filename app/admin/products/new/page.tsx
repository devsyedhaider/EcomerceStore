  ...
  return (
    <div className="space-y-10 pb-20">
      <div className="flex items-center gap-4">
        ...
        <div>
           <h1 className="text-4xl font-black uppercase tracking-tighter">Add New Product</h1>
           <p className="text-zinc-500 font-medium tracking-tight">Create a new entry in your stock.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="space-y-8">
            ...
            <div className="bg-white p-8 rounded-[32px] border border-zinc-200 shadow-sm space-y-4">
                ...
                >
                    {isLoading ? <div className="w-6 h-6 border-4 border-white/20 border-t-white rounded-full animate-spin" /> : <><Save className="w-5 h-5" /> PUBLISH PRODUCT</>}
                </button>
                <button 
                  type="button"
                  onClick={() => router.back()}
